...
public class ChatService {
    ...
    public ResponseDTO<Integer> addChat(ChatDTO chatDTO){
        ...
        return new ResponseDTO<Integer>(true, AppCode.OK, AppMessages.OK, chat.getId());
    }
    ...
    public ResponseDTO<ChatUsers> addChatUsers(ChatUsers chatUsers) {
        chatUsersRepository.save(chatUsers);
        return ResponseDTO.<ChatUsers>builder().code(0).message("Ok").success(true).data(chatUsers).build();
    }
}
