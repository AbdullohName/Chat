...
public class UserService {
    ...
    public ResponseDTO<UserDTO> addUser(UserDTO userDTO) {
        ...
        return new ResponseDTO<UserDTO>(true, OK, SAVED, userDTO);
    }
    ...
    @Transactional
    public ResponseDTO<Integer> deleteByUsername(String username) {
        if(userRepository.existsByUsername(username)) {
            Integer howMany = userRepository.deleteUserByUsername(username);
